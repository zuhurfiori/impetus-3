...
//                         New Case ID1001
//                     </div>
//                     <form action="../" form="newCase">

//                         <div className="createCase">
//                             <div className="toDo">
//                                 <div className="comments">
//                                     <h5>Comments</h5>
//                                     <textarea rows="7" cols="30" name="comment" form="newCase" placeHolder="Enter Comments here...">
//                                     </textarea>
//                                 </div>
...
//                                 <h5>Tasks</h5>
//                                 <textarea rows="10" cols="30" name="Tasks" form="newCase" placeHolder="Enter Tasks here...">
//                                 </textarea>
//                             </div>
...
//                             <button className="button-green" >Create A Case </button>
